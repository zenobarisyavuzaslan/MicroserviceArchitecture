...
namespace FreeCourse.Web.Services
{
    public class OrderService : IOrderService
    {
        ...
        public async Task<OrderCreatedViewModel> CreateOrder(CheckoutInfoInput checkoutInfoInput)
        {
            ...
            orderCreateInput.BuyerId = _sharedIdentityService.GetUsetId;
            orderCreateInput.Address = new AddressCreateInput
            {
            ...
            orderCreateInput.OrderItems = new List<OrderItemCreateInput>();
