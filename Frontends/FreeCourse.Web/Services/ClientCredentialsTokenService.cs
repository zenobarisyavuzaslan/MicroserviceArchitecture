...
namespace FreeCourse.Web.Services
{
    public class ClientCredentialsTokenService : IClientCredentialsTokenService
    {
        ...
        public async Task<string> GetToken()
        {
            ...
            var clientCredantialTokenRequest = new ClientCredentialsTokenRequest
            {
                ClientId = _clientSettings.WebClient.ClientId,
                ClientSecret = _clientSettings.WebClient.ClientSecret,
                Address = disco.TokenEndpoint
            };
            var newToken = await _httpClient.RequestClientCredentialsTokenAsync(clientCredantialTokenRequest);
